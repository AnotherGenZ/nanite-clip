    ...
    fn sample_app(mut config: Config) -> App {
        ...
        App {
            ...
            clips: ClipLibraryState {
                ...
                bulk_collection_editor_options: iced::widget::combo_box::State::new(Vec::new()),
                selected_collection_add_id: None,
                pending_collection_membership: None,
            ...
            settings: SettingsState {
                ...
                s3_secret_access_key_present: false,
                s3_session_token_input: String::new(),
                s3_session_token_present: false,
