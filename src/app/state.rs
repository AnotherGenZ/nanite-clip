...
pub(crate) struct SettingsState {
    ...
    pub s3_canned_acl: String,
    pub s3_path_style: bool,
    pub s3_secret_access_key_input: String,
    pub s3_secret_access_key_present: bool,
    pub s3_session_token_input: String,
    pub s3_session_token_present: bool,
    ...
    pub collapsed_delivery_sections: Vec<tabs::settings::DeliverySection>,
