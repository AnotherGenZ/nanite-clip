...
#[cfg(target_os = "linux")]
pub(crate) async fn run_wayland_hotkey_session(
...
#[cfg(target_os = "linux")]
pub(crate) fn kde_shortcut_sequence(binding: &str) -> Result<KdeShortcutSequence, String> {
...
#[cfg(target_os = "linux")]
pub(crate) fn first_wayland_binding_label(
...
pub(crate) fn parse_hotkey(binding: &str) -> Result<HotKey, String> {
...
#[cfg(target_os = "linux")]
pub(crate) fn portal_preferred_trigger(binding: &str) -> Option<String> {
...
#[cfg(target_os = "linux")]
pub(crate) async fn clear_plasma_portal_shortcut_conflict() -> Result<(), String> {
